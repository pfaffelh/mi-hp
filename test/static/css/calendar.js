...
class Calendar {
  ...
  renderCalendar() {
      ...
      content += '            <button class="btn btn-primary previousMonth overflowHidden" style="width:100%;background-color:#00a082;">' + this.t().btnPreviousMonth + '</button>' + "\n";
      content += '        </div>' + "\n"
      content += '        <div class="col-md-3 col-sm-6 mb-3">' + "\n";
      content += '            <button class="btn btn-primary nextMonth overflowHidden"  style="width:100%;background-color:#00a082;">' + this.t().btnNextButton + '</button> ' + "\n";
      content += '        </div>' + "\n"
      content += '    </div>' + "\n"
      content += '</div>' + "\n"
