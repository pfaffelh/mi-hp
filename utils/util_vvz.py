...
def get_data(sem_shortname, lang = "de", studiengang = "", modul = "", veranstaltungs_query = {}, vpn = False):
    ...
    for rubrik in rubriken:
        ...
        for veranstaltung in veranstaltungen:
            ...
            v_dict["verwendbarkeit_kommentar"] = veranstaltung[f"kommentar_verwendbarkeit_{lang}"] if veranstaltung[f"kommentar_verwendbarkeit_{lang}"] != "" else veranstaltung[f"kommentar_verwendbarkeit_{otherlang}"]
