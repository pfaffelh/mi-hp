 ...
 * Website and documentation: https://van11y.net/accessible-modal/
...
(doc => {
    ...
    const MODAL_OVERLAY_TXT = __('Close', 'unifreiburg-theme');
                    ...
                    doc.body
                        .addEventListener(eventName, e => {
                            ...
                            if ((hasClass(e.target, MODAL_JS_CLASS) === true || parentModalLauncher !== '') && eventName === 'click') {
                                ...
                                let modalPrefixClass = modalLauncher.hasAttribute(MODAL_PREFIX_CLASS_ATTR) === true ? modalLauncher.getAttribute(MODAL_PREFIX_CLASS_ATTR) + ' ' : ''; // rewritten for using own classes
                                ...
                                // This one is important to register the DOM and make Accordions Clickable!
                                runAccordionScript()
